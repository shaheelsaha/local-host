    ...
    <footer className="py-10 border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 text-gray-600 dark:text-gray-400">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8">
                ...
                <div>
                    <h5 className="font-bold text-gray-900 dark:text-white mb-3">Product</h5>
                    ...
                    <div>
                    <h5 className="font-bold text-gray-900 dark:text-white mb-3">Company</h5>
                    <ul className="space-y-2 text-sm">
                ...
                <div>
                    <h5 className="font-bold text-gray-900 dark:text-white mb-3">Support</h5>
                    <ul className="space-y-2 text-sm">
                    ...
                    <div>
                    <h5 className="font-bold text-gray-900 dark:text-white mb-3">Social</h5>
                    <ul className="space-y-2 text-sm">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center text-sm">
                <p className="text-gray-500 dark:text-gray-500">&copy; {new Date().getFullYear()} SAHA AI. All Rights Reserved.</p>
                <div className="flex space-x-6 mt-4 sm:mt-0">
                    ...
                    <a href="/cookies" className="hover:text-gray-900 dark:hover:text-white transition-colors">Cookies</a>
                </div>
            </div>
        </div>
    </footer>
