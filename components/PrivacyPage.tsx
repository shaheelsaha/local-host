...
const PrivacyPage: React.FC = () => (
    <LegalPageLayout title="Privacy Policy">
        <p>
            This Privacy Policy describes how SAHA AI (“we”, “our”, or “us”) collects, uses, and protects your personal information when you use our website <a href="https://sahaai.io">https://sahaai.io</a> and related services (the “Service”).
        </p>
        <p>
        ...
        <p>To submit a request, please contact us at: <a href="mailto:shaheel@sahaai.io">shaheel@sahaai.io</a></p>
        ...
        <p><strong>Email:</strong> <a href="mailto:shaheel@sahaai.io">shaheel@sahaai.io</a></p>
        <p><strong>Website:</strong> <a href="https://sahaai.io">https://sahaai.io</a></p>
    </LegalPageLayout>
);
