...
const Commands: React.FC<CommandsProps> = ({ user }) => {
    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Commands</h1>
            <p className="text-gray-500 dark:text-gray-400 mb-6">Create and manage a custom command prompt for AI-powered actions. This command will be used for auto-commenting.</p>
                ...
                <form onSubmit={handleSave} className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 space-y-6">
                     <div>
                        ...
                        <textarea 
                            ...
                            className="w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 outline-none transition font-mono text-xs leading-relaxed"
                        />
                        <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">This is the main instruction for the AI. You can edit or replace this default prompt.</p>
                    </div>
