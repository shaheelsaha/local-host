    ...
    return (
        <>
            ...
            <div
                ...
                aria-hidden="true"
            ></div>
            <aside className={`fixed inset-y-0 left-0 bg-gray-950 text-gray-200 p-4 flex flex-col z-50 transform transition-all duration-300 ease-in-out md:relative md:translate-x-0 border-r border-gray-800 ${isOpen ? 'translate-x-0' : '-translate-x-full'} ${isCollapsed ? 'md:w-20' : 'md:w-64'}`}>
