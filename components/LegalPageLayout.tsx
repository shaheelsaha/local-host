...
const LegalPageLayout: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => {
    return (
        <div className="bg-gray-50 dark:bg-gray-950 min-h-screen font-sans text-gray-700 dark:text-gray-200">
            <style>{`
                .legal-content h2 {
                    font-size: 1.5rem;
                    font-weight: 600;
            ...
            <main className="container mx-auto p-4 md:p-8">
                <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 p-8 sm:p-12 rounded-2xl border border-gray-200 dark:border-gray-800">
                    <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-gray-900 dark:text-white">{title}</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-500 mb-8">Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
