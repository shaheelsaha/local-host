             ...
             <div className="relative z-10 w-full flex flex-col items-center">
                <div className="text-center mb-10">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tracking-tight">
                        Create Your <span className="text-blue-600 dark:text-blue-500">SAHA AI</span> Account
                    </h1>
                ...
                <div className="w-full max-w-md p-6 sm:p-8 space-y-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl shadow-lg dark:shadow-2xl dark:shadow-black/30">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            <label htmlFor="name" className="text-sm font-medium text-gray-700 dark:text-gray-300 sr-only">Full Name</label>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                />
                                <button type="button" onClick={() => setPasswordVisible(!passwordVisible)} className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
